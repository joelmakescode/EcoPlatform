...
func (s *DiscordUserService) LinkAccount(userId, code string) (*api.LinkedAccountID, error) {
	...
	accountLink := &model.AccountDiscordLink{
...
func (s *DiscordUserService) MapUserToModel(user *api.CreateDiscordUserData) *model.DiscordUser {
	return &model.DiscordUser{
		DiscordId:    user.DiscordId,
		PasswordHash: user.Password,
	}
}

func (s *DiscordUserService) MapModelToApiDiscordUser(user *model.DiscordUser) *api.DiscordUser {
...
func (s *DiscordUserService) MapModelToDiscordUserSessionData(user *model.DiscordUser) *api.DiscordUserSessionData {
